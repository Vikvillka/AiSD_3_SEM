...
void dijkstra(int graph[V][V], int src)
{
	...
	bool sptSet[V]; // будет true если вершина i включена в кратчайший путь
	...
	for (int count = 0; count < V - 1; count++)
	{
		...
		// добав выбранную вершину в кратчайший путь
		sptSet[u] = true;

		// обнов значение расстояния соседних вершин выбранной вершины
		for (int v = 0; v < V; v++)

			// обнов dist[v] только если не в sptSet, есть ребро от u до v и вес ребра меньше текущего значения dist[v]
